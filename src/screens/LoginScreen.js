...
const LoginScreen = ({ navigation }) => {
    ...
    const handleLogin = async () => {
        try {
            console.log('Sending login request to:', `https://tusa-koeln.de/api/auth/login/api/auth/login`);
            const response = await axios.post(`https://tusa-koeln.de/api/auth/login`, { email, password });
